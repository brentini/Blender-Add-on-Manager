...
var blAddonChecker = {
    ...
    checkBlVer: function() {
        if (this.osInfo['type'] == "Windows_NT") {
            ...
            this.blVers = this.blVers.filter(function(dir) {
                return fs.statSync(blUserPath + dir).isDirectory() && /[0-9]\.[0-9]{2}$/.test(dir);
            });
            console.log(this.blVers);
        }
    },
