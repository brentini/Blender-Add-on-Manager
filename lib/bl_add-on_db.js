...
var blAddonDB = {
    ...
    setPage: function (startPage, endPage, minFileSize, maxFileSize) {
    ...
    getRepoURLs: function () {
        ...
        return new Promise(function(res) {
            function loop(page) {
                console.log(page);
                return new Promise(function(resolve, reject) {
                    var que = 'bl_info+blender+language:python+size:' + obj.minFileSize + '..' + obj.maxFileSize;
                    console.log(que);
                    client.fetch(
                        'https://github.com/search',
                        {
                            //q: 'bl_info+blender+size:0..1000',
                            q: 'bl_info+blender+extension:py+size:' + obj.minFileSize + '..' + obj.maxFileSize,
                            type: 'Code',
                            ref: 'searchresults',
                            p: page
                        },
